...
class CreateStepScreen extends StatefulWidget {
  const CreateStepScreen({super.key});
              ...
              if (onBordingProvider.name.text.isNotEmpty &&
                ...
                BlocProvider.of<OnbordingCubit>(context)
                  ...
                  if (value == "true" || value == true) {
                    BlocProvider.of<OnbordingCubit>(
                ...
                BlocProvider.of<OnbordingCubit>(context)
                    .registerUserApi(
                        ...
                        bday: onBordingProvider.bdatePicker
                            ...
                            .split(" ")
                            .first,
                        searchPreference: onBordingProvider
                            .maleFemaleBoth(onBordingProvider.select1),
                        rediusSearch:
                        ...
                        gender: onBordingProvider
                            .maleFemaleOther(onBordingProvider.select),
          ...
          children: [
            Text(
              ...
              AppLocalizations.of(context)
                      ?.translate("Can you elaborate on your identity? 😎") ??
            ...
            Text(
              ...
              AppLocalizations.of(context)?.translate(
                      "It will Display on your Profile and you will not able to change it later") ??
                  "It will Display on your Profile and you will not able to change it later",
            ...
            TextFieldPro(
              ...
              suffixIconPath: onBordingProvider.isLast
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)
                    ?.translate("Your GoMeet identity 😎") ??
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)?.translate("Let's celebrate you 🎂") ??
                "Let's celebrate you 🎂",
            style: Theme.of(context).textTheme.headlineMedium,
            textAlign: TextAlign.center,
          ),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)?.translate("Be true to yourself 🌟") ??
                "Be true to yourself 🌟",
            style: Theme.of(context).textTheme.headlineMedium,
          ),
          const SizBoxH(size: 0.012),
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              AppLocalizations.of(context)
                      ?.translate("Your relationship goals 💘") ??
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)?.translate("Find matches nearby📍") ??
                "Find matches nearby📍",
            style: Theme.of(context).textTheme.headlineMedium,
          ),
          const SizBoxH(size: 0.012),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text(
              ...
              AppLocalizations.of(context)?.translate("Distance Preference") ??
                  "Distance Preference",
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)
                    ?.translate("Discover like-minded people 🤗") ??
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              AppLocalizations.of(context)
                      ?.translate("Do you know which languages? 🗺️") ??
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)?.translate("Discover religion 🤗") ??
                "Discover religion 🤗",
            style: Theme.of(context).textTheme.headlineMedium,
          ),
          const SizBoxH(size: 0.012),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)?.translate("Search Preference 🌟") ??
                "Search Preference 🌟",
            style: Theme.of(context).textTheme.headlineMedium,
          ),
          const SizBoxH(size: 0.012),
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            AppLocalizations.of(context)?.translate("Show your best self 📸") ??
                "Show your best self 📸",
            style: Theme.of(context).textTheme.headlineMedium,
          ),
          const SizBoxH(size: 0.012),
