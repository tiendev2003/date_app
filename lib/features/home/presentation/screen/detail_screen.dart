...
import '../../../likematch/bloc/match_cubit.dart';
          ...
          if (state is HomeCompleteState) {
            return Container(
              ...
              decoration: BoxDecoration(
                color: (detailProvider.status != "1" &&
                        detailProvider.status != "3" &&
                      ...
                      ? Row(
                          children: [
                                ...
                                BlocProvider.of<MatchCubit>(context)
                                    .profileLikeDislikeApi(
                                        ...
                                        proId: detailProvider
                                            .detailModel.profileinfo!.profileId
                                            .toString(),
                            ...
                            (detailProvider.status == "3" ||
                                    state.homeData.planId == "3")
                                ? const SizBoxW(size: 0.05)
                                : const SizBoxW(size: 0),
                          ],
                        )
                      : const SizedBox(),
                  (detailProvider.status == "3" || state.homeData.planId == "3")
                      ? Row(
                          children: [
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) => ChattingPage(
                                              proPic: detailProvider
                                                  .detailModel
                                                  .profileinfo!
                                                  .profileImages!
                                                  .first,
                                              resiverUserId: detailProvider
                                                  .detailModel
                                                  .profileinfo!
                                                  .profileId
                                                  .toString(),
                                              resiverUseremail: detailProvider
                                                  .detailModel
                                                  .profileinfo!
                                                  .profileName
                                                  .toString(),
                  ...
                  state.homeData.planId == "0"
                      ? Row(
                          children: [
                            ...
                            if (detailProvider.status == "3" ||
                                (detailProvider.status != "3" &&
                                    detailProvider.status != "2"))
                              const SizBoxW(size: 0.05),
                          ],
                        )
                      : const SizedBox(),
                  (detailProvider.status != "3" && detailProvider.status != "2")
                      ? Row(
                          children: [
                            state.homeData.planId == "0"
                                ? const SizedBox()
                ...
                slivers: [
                  SliverAppBar(
                          ...
                          child: Container(
                            ...
                            child: BackdropFilter(
                              ...
                              child: RichText(
                                ...
                                TextSpan(
                                  text:
                                      "${detailProvider.detailModel.profileinfo!.profileDistance} ",
                                            ...
                                            builder: (BuildContext context) =>
                                              ...
                                              title: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    'Blocking ${detailProvider.detailModel.profileinfo!.profileName}',
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .headlineSmall!
                                                  ...
                                                  Text(
                                                    'Please tell us why you are blocking ${detailProvider.detailModel.profileinfo!.profileName}. Don`t worry we won`t tell them.',
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .bodySmall!,
                                                            ...
                                                            detailProvider
                                                                .profileblockApi(
                                                                    context:
                                                                        context,
                                                                    profileblock:
                                                                        "${detailProvider.detailModel.profileinfo!.profileId}");
                                                  ...
                                                  child: AlertDialog(
                                                    ...
                                                    title: Column(
                                                      ...
                                                      children: [
                                                        Center(
                                                            child: Text(
                                                                'Reporting ${detailProvider.detailModel.profileinfo!.profileName}',
                                                                style: Theme.of(
                                                                        context)
                                                                    .textTheme
                                                                    .headlineSmall!
                                                        ...
                                                        Text(
                                                          'Please tell us why you are reporting ${detailProvider.detailModel.profileinfo!.profileName}. Don`t worry we won`t tell them.',
                                                          style:
                                                              Theme.of(context)
                                                                  .textTheme
                                                                  .bodySmall!,
                                                            ...
                                                            Expanded(
                                                              child:
                                                                ...
                                                                onPressed: () {
                                                                  Navigator.pop(
                                                                      context);
                                                                  detailProvider.profilereportApi(
                                                                      context:
                                                                          context,
                                                                      reportid:
                                                                          "${detailProvider.detailModel.profileinfo!.profileId}",
                    ...
                    bottom: PreferredSize(
                      ...
                      child: Column(
                        children: [
                          detailProvider.detailModel.profileinfo!.profileImages!
                                      .length >
                                  1
                              ? SizedBox(
                                  height: 25,
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      background: CarouselSlider.builder(
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(
                                        "${Config.baseUrl}${detailProvider.detailModel.profileinfo!.profileImages![itemIndex]}"),
                                    fit: BoxFit.cover),
                              ),
                            );
                          },
                          options: CarouselOptions(
                              viewportFraction: 1,
                              height: MediaQuery.of(context).size.height / 2,
                              autoPlay: detailProvider.detailModel.profileinfo!
                                          .profileImages!.length >
                                      1
                                  ? true
                                  : false,
                              enableInfiniteScroll: detailProvider.detailModel
                                          .profileinfo!.profileImages!.length >
                                      1
                                  ? true
                                  : false,
                              onPageChanged: (i, r) {
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              detailProvider
                                          .detailModel.profileinfo!.isVerify ==
                                      "0"
                                  ? const Padding(
                          ...
                          Text(
                            detailProvider
                                    .detailModel.profileinfo!.profileBio ??
                                "",
                            ...
                            children: [
                              for (int a = 0;
                                ...
                                Builder(builder: (context) {
                                  InterestListElement data = detailProvider
                                      .detailModel
                                      .profileinfo!
                                      .interestList![a];
                                  return InkWell(
                          ...
                          const SizBoxH(size: 0.03),
                          detailProvider.detailModel.profileinfo!.height == null
                              ? const SizedBox()
                              : Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
