...
import '../../../chatting/presentation/screen/chat_page.dart';
import '../../../edit_profile/bloc/editprofile_provider.dart';
import '../../../likematch/bloc/likematch_provider.dart';
import '../../../onboarding/bloc/onbording_cubit.dart';
import '../../../onboarding/bloc/onbording_provider.dart';
import '../../bloc/detail_provider.dart';
import '../../bloc/home_cubit.dart';
import '../../bloc/home_provier.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    homeProvider.controller = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 400),
    );
    homeProvider.animation =
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      homeProvider.userlocalData.userLogin!.profilePic != null
                          ? Container(
                              height: 50,
                              width: 50,
                      ...
                      InkWell(
                          onTap: () {
                            state.homeData.filterInclude == "0"
                        ...
                        children: [
                          ...
                          Text(
                              AppLocalizations.of(context)?.translate(
                                      "Change your preferences to expand your search and see new profiles.") ??
                                  "Change your preferences to expand your search and see new profiles.",
                          ...
                          MainButton(
                            ...
                            title: AppLocalizations.of(context)
                                    ?.translate("Change my preferences") ??
                      ...
                      children: [
                        PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            int nextIndex = homeProvider.currentIndex ==
                                    state.homeData.profilelist!.length - 1
                                ? 0
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    image: DecorationImage(
                                                        image: NetworkImage(
                                                            "${Config.baseUrl}${state.homeData.profilelist![nextIndex].profileImages!.first}"),
                                                        fit: BoxFit.cover)),
                                              ),
                                              Stack(
                                                alignment:
                                                                ...
                                                                children: [
                                                                  Stack(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      state.homeData.profilelist![nextIndex].isSubscribe !=
                                                                              "0"
                                                                          ? Row(
                                                                              children: [
                                                                                Image.asset(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                Theme.of(context).textTheme.bodyMedium!.copyWith(color: AppColors.white, fontSize: 12),
                                                                            overflow:
                        ...
                        InkWell(
                          onTap: () {
                            print("object");
                            var lat = Provider.of<OnBordingProvider>(context,
                                    listen: false)
                                .lat;
                            var long = Provider.of<OnBordingProvider>(context,
                                    listen: false)
                                .long;
                                          ...
                                          child: Stack(
                                            children: [
                                              CarouselSlider.builder(
                                                itemCount: state
                                                    .homeData
                                                    .profilelist![homeProvider
                                                        .currentIndex]
                                                    .profileImages!
                                                    .length,
                                                carouselController: homeProvider
                                                    .carouselController,
                                                itemBuilder:
                                                  ...
                                                  return Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        image: DecorationImage(
                                                            image: NetworkImage(
                                                                "${Config.baseUrl}${state.homeData.profilelist![homeProvider.currentIndex].profileImages![itemIndex]}"),
                                                            fit: BoxFit.cover)),
                                                  );
                                                },
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  const SizBoxH(
                                                                      size:
                                                                          0.02),
                                                                  state.homeData.profilelist![homeProvider.currentIndex]
                                                                              .isSubscribe !=
                                                                          "0"
                                                                      ? Row(
                                                                          children: [
                                                                      ...
                                                                      : const SizedBox(),
                                                                  state.homeData.profilelist![homeProvider.currentIndex].isSubscribe !=
                                                                          "0"
                                                                      ? const SizBoxH(
                                                                          size:
                                                                              0.02)
                              ...
                              children: [
                                Expanded(
                                  child: ListView.separated(
                                      ...
                                      itemCount:
                                          homeProvider.flotingIcons.length,
                                      shrinkWrap: true,
                                      ...
                                      itemBuilder: (c, i) {
                                        return Center(
                                          child: InkWell(
                                            onTap: () {
                                              if (i == 2 &&
                                                  state.homeData.planId ==
                                                      "0") {
                                                Navigator.pushNamed(
                                                    context, "/premiumScreen");
                                              }

                                              if (state.homeData.profilelist!
                                                  .isNotEmpty) {
                                                if (i == 0) {
                                                  homeProvider.cancleButton(
                                                      state, context);
                                                  BlocProvider.of<
                                                              HomePageCubit>(
                                                          context)
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder:
                                                                      (context) =>
                                                                          ChattingPage(
                                                                            proPic:
                                                                                state.homeData.profilelist![homeProvider.currentIndex].profileImages!.first,
                                                                            resiverUserId:
                                                                                state.homeData.profilelist![homeProvider.currentIndex].profileId!,
                                                                            resiverUseremail:
                                                                                state.homeData.profilelist![homeProvider.currentIndex].profileName!,
                                                                          )));
          ...
          listener: (context, state) {
            ...
            if (state is HomeCompleteState) {
              if (state.homeData.totalliked!.isNotEmpty) {
                Provider.of<LikeMatchProvider>(context, listen: false)
                    .likeMatchData
                    .addAll(state.homeData.totalliked!);
                Provider.of<LikeMatchProvider>(context, listen: false)
                    .updateIsHome(true);
                Navigator.pushNamed(context, "/likeMatchScreen").then((value) {
                  BlocProvider.of<HomePageCubit>(navigatorKey.currentContext!)
                      .getHomeData(
                          uid: homeProvider.uid,
