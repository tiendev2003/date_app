...
import '../../../core/model/get_bloc_list_model.dart';
import '../../../core/theme/ui.dart';
import '../../../widget/common_shimmer_widget.dart';
import '../../home/bloc/home_provier.dart';
import '../presentation/widget/chat_bubble.dart';
...
class ChattingProvider extends ChangeNotifier {
  ...
  Future demo1(context) async {
    userData.clear();
    Stream<QuerySnapshot<Map<String, dynamic>>> snep =
        FirebaseFirestore.instance.collection("datingUser").snapshots();
    snep.forEach((element) {
      ...
      for (int a = 0; a < data.length; a++) {
        ...
        print("* * :-- ${data[a].data()}");
        Stream<QuerySnapshot<Object?>> snapshot = chatservices.getMessage(
            userId: dataa["uid"],
            otherUserId: Provider.of<HomeProvider>(context, listen: false).uid);
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Row(
                        ...
                        children: [
                          CommonShimmerWidget(
                              ...
                              radius: 20,
                              width: 80,
                              customGeometry: BorderRadius.only(
            ...
            return ListView(
              ...
              children: snapshot.data!.docs.isEmpty
                  ...
                  : snapshot.data!.docs
                      .map((document) => buildMessageiteam(document, context))
                      .toList(),
            );
          }
        });
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ChatBubble(
              chatColor: (data["senderid"] ==
                      Provider.of<HomeProvider>(context, listen: false).uid)
                  ? AppColors.appColor
                  : Colors.grey.shade100,
              textColor: (data["senderid"] ==
                      Provider.of<HomeProvider>(context, listen: false).uid)
                  ? Colors.white
                  : Colors.black,
              message: data["message"],
              alingment: (data["senderid"] ==
                      Provider.of<HomeProvider>(context, listen: false).uid)
                  ? false
                  : true,
            ),
  ...
  void sendMessage(
    ...
    try {
          ...
          try {
            ...
            Fluttertoast.showToast(
                msg: AppLocalizations.of(context)
                        ?.translate("Something Want Wrong") ??
      ...
      Fluttertoast.showToast(
          msg:
              AppLocalizations.of(context)?.translate("Something Want Wrong") ??
                  "Something Want Wrong");
    }
  }
  ...
  void sendPushMessage(String body, String title, String token, context) async {
    try {
      await _api.sendRequest.post(Config.notificationUrl,
          data: <String, dynamic>{
            ...
            'data': <String, dynamic>{
              ...
              'name': Provider.of<HomeProvider>(context, listen: false)
                  .userlocalData
                  .userLogin!
                  .name,
              'propic': Provider.of<HomeProvider>(context, listen: false)
                  .userlocalData
                  .userLogin!
                  .otherPic
                  .toString()
  ...
  Future vcNotificationMessage(
      String body, String title, String token, context, String vcId) async {
    try {
      await _api.sendRequest.post(Config.notificationUrl,
          data: <String, dynamic>{
            'notification': <String, dynamic>{
  ...
  Future audioNotificationMessage(
      String body, String title, String token, context, String vcId) async {
    try {
      await _api.sendRequest.post(Config.notificationUrl,
          data: <String, dynamic>{
  ...
  Future getblockklisttApi(context) async {
    ...
    try {
      var response = await _api.sendRequest
          .post("${Config.baseUrlApi}${Config.getblockapi}", data: data);
      print("+ + + + + +:----- ${response.data}");
