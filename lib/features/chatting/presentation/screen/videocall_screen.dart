...
class _VideocallScreenState extends State<VideocallScreen> {
  ...
  void initState() {
    ...
    vcProvider.initAgora(
        Config.agoraVcKey, Config.agoraVcKey, widget.channel, context);
        ...
        children: [
          ...
          Align(
            ...
            child: SizedBox(
              ...
              height: 150,
              child: Center(
                child: vcProvider.localUserJoined
                    ? AgoraVideoView(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      await vcProvider.engine
                          .muteAllRemoteAudioStreams(vcProvider.muteUnmute);
                      setState(() {});
                    },
                    child: Container(
                      height: 50,
