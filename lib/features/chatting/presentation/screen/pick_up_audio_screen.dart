...
import '../../../../main.dart';
import '../../bloc/audiocall_provider.dart';
import 'chat_page.dart';

class PickUpAudioScreen extends StatefulWidget {
  const PickUpAudioScreen(
      {super.key, required this.userData, required this.channel});
  final Map userData;
  final String channel;
  @override
  State<PickUpAudioScreen> createState() => _PickUpAudioScreenState();
}

class _PickUpAudioScreenState extends State<PickUpAudioScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: audioCallProvider.isLoading
          ...
          : Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      audioCallProvider.returnFormattedText(),
                      style: Theme.of(context)
                          .textTheme
                          .bodyMedium!
                          .copyWith(color: Colors.white),
                      ...
                      children: [
                        InkWell(
                          onTap: () async {
                            ...
                            await audioCallProvider.agoraEngine
                                .muteAllRemoteAudioStreams(
                                    audioCallProvider.muteUnmute);
                          },
                          child: Container(
                            height: 50,
                            width: 50,
