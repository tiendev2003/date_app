...
import '../../../home/bloc/detail_provider.dart';
import '../../../home/bloc/home_cubit.dart';
import '../../../home/bloc/home_provier.dart';
import '../../../home/bloc/home_state.dart';
import '../../../home/presentation/screen/detail_screen.dart';
import '../../../premium/bloc/premium_provider.dart';
import '../../bloc/chatting_provider.dart';
      ...
      body: Stack(
        ...
        children: [
          Column(
            children: [
              Expanded(
                child: chattingProvider.buildMessageList(
                    context: context, resiverUserId: widget.resiverUserId),
              ),
              chattingProvider.buildMessageInpurt(
                  resiverUserId: widget.resiverUserId, context: context),
            ],
          ),
      ...
      title: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.active) {
                    ...
                    children: [
                      proPic == "null"
                          ...
                          : CircleAvatar(
                              ...
                              backgroundColor: Colors.transparent,
                              backgroundImage:
                                  NetworkImage("${Config.baseUrl}$proPic")),
                      const SizedBox(
                        width: 10,
                      ),
                      Expanded(
                      ...
                      InkWell(
                                ...
                                _firebaseStorage
                                  ...
                                  chattingProvider
                                      .audioNotificationMessage(
                                          "In Coming Audio Call From ${Provider.of<HomeProvider>(navigatorKey.currentContext!, listen: false).userlocalData.userLogin!.name}",
                          ...
                          child: SvgPicture.asset(
                            ...
                            colorFilter: ColorFilter.mode(
                                homeProvider.userlocalData.userLogin!.planId ==
                                        "1"
                                    ? Theme.of(context)
                                        .indicatorColor
                                        .withOpacity(0.2)
                                    : homeProvider.userlocalData.userLogin!
                                                .planId ==
                                            "2"
                                        ? Theme.of(context)
                                            .indicatorColor
                                  ...
                                  if (value.data()!["isVc"] == true) {
                                    chattingProvider
                                        .vcNotificationMessage(
                                            "In Coming Video Call From ${Provider.of<HomeProvider>(navigatorKey.currentContext!, listen: false).userlocalData.userLogin!.name}",
                                            Provider.of<HomeProvider>(
                                                    navigatorKey
                                                        .currentContext!,
                                                    listen: false)
                      ...
                      PopupMenuButton(
                        ...
                        itemBuilder: (context) => <PopupMenuEntry<SampleItem2>>[
                          PopupMenuItem(
                              enabled: true,
                              onTap: () {},
                              child: Column(
                                          ...
                                          builder: (BuildContext context) =>
                                            ...
                                            title: Column(
                                              children: [
                                                ...
                                                Text(
                                                  'Please tell us why you are blocking ${widget.resiverUseremail}. Don`t worry we won`t tell them.',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .bodySmall!,
                                                ...
                                                child: AlertDialog(
                                                  ...
                                                  title: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        'Please tell us why you are reporting ${widget.resiverUseremail}. Don`t worry we won`t tell them.',
                                                        style: Theme.of(context)
                                                            .textTheme
                                                            .bodySmall!,
                                                        textAlign:
              ...
              return Row(
                children: [
                  const CommonShimmerWidget(height: 42, width: 42, radius: 50),
                  const SizedBox(
                    width: 10,
                  ),
                  Column(
