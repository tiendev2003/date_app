                      ...
                      onTap: () async {
                        try {
                          ...
                          await FirebaseAuth.instance.signInWithCredential(credential).then((value) {
                            if (value.user != null) {
                              finalApiCall(navigatorKey.currentContext,true);
                            }
                          });
                        } catch (e) {
                          // Fluttertoast.showToast(msg: "OTP Invalid".tr);
                          Fluttertoast.showToast(msg: AppLocalizations.of(navigatorKey.currentContext!)?.translate("OTP Invalid") ?? "OTP Invalid");
                        }
                      },
                    )
                  ],
