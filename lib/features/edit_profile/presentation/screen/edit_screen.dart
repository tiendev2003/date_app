...
import '../../bloc/editprofile_provider.dart';
...
class _EditScreenState extends State<EditScreen> {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: MainButton(
              ...
              onTap: () {
                if (editProvider.mobileNumber.text.compareTo(
                          ...
                          children: [
                            Wrap(
                                ...
                                children: [
                                  ...
                                  for (int a = 0;
                                      a < editProvider.newImage.length;
                                      a++)
                                    Stack(
                                      clipBehavior: Clip.none,
                                      alignment: Alignment.topRight,
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      final XFile? image =
                                          await editProvider.picker.pickImage(
                            ...
                            commenTile(
                                ...
                                widget: IntlPhoneField(
                                  ...
                                  onCountryChanged: (value) {
                                    editProvider.ccode = editProvider
                                        .updateVeriable(value.dialCode);
                                  },
                                  onChanged: (value) {
                                    editProvider.updateNameFiled(
                                        controller: editProvider.mobileNumber,
                                        ...
                                        return InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                border: Border.all(
                                                    color:
                                                        editProvider.gender == a
                                                            ? AppColors.appColor
                                                            : Theme.of(context)
                                                                .dividerTheme
                                                                .color!)),
                                            child: Text(
                                                editProvider.manWoman[a]
                                                    .toString(),
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .bodySmall!
                                          ...
                                          return Container(
                                            ...
                                            child: Scaffold(
                                              bottomNavigationBar: MainButton(
                                                bgColor: AppColors.appColor,
                                                title:
                                                    "Ok(${editProvider.interestList.length}/5)",
                                                onTap: () {
                                                                  ...
                                                                  for (int a =
                                                                    ...
                                                                    Builder(builder:
                                                                      ...
                                                                      return InkWell(
                                                                        onTap:
                                                                            () {
                                                                          if (editProvider.interestList.contains(data.id) ==
                                                                              true) {
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              border: Border.all(color: editProvider.interestList.contains(data.id) ? Colors.transparent : Theme.of(context).dividerTheme.color!)),
                                                                          child:
                                                                              Row(
                                                                            mainAxisSize:
                                                                                MainAxisSize.min,
                                                                            children: [
                                                                              Text(data.title.toString(), style: Theme.of(context).textTheme.bodySmall!.copyWith(color: editProvider.interestList.contains(data.id) ? AppColors.white : null)),
                                                                              const SizedBox(
                                                                                width: 5,
                                                                              ),
                                                                              Image.network(
                                    ...
                                    children: [
                                      for (int a = 0;
                                        ...
                                        Builder(builder: (context) {
                                          ...
                                          return (editProvider.interestList
                                                  .contains(data.id))
                                              ? Container(
                                                                  ...
                                                                  for (int a =
                                                                    ...
                                                                    Builder(builder:
                                                                      ...
                                                                      return InkWell(
                                                                        onTap:
                                                                            () {
                                                                          if (editProvider.languageList.contains(data.id) ==
                                                                              true) {
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              borderRadius: BorderRadius.circular(40),
                                                                              border: Border.all(color: editProvider.languageList.contains(data.id) ? Colors.transparent : Theme.of(context).dividerTheme.color!)),
                                                                          child:
                                                                              Row(
                                                                            mainAxisSize:
                                                                                MainAxisSize.min,
                                                                            children: [
                                                                              Text(data.title.toString(), style: Theme.of(context).textTheme.bodySmall!.copyWith(color: editProvider.languageList.contains(data.id) ? AppColors.white : null)),
                                                                              const SizedBox(
                                                                                width: 5,
                                                                              ),
                                                                              Image.network(
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      for (int a = 0;
                                        ...
                                        Builder(builder: (context) {
                                          Languagelist data =
                                              editProvider.language![a];
                                          return (editProvider.languageList
                                                  .contains(data.id))
                                              ? Container(
                                                  margin: const EdgeInsets
                                                      .symmetric(horizontal: 5),
                                                                  ...
                                                                  for (int a =
                                                                    ...
                                                                    Builder(builder:
                                                                      ...
                                                                      return InkWell(
                                                                        onTap:
                                                                            () {
                                                                          editProvider.updatereligion(int.parse(data
                                                                              .id
                                                                              .toString()));
                                                                        },
                                                                        child:
                                                                          ...
                                                                          padding: const EdgeInsets
                                                                              ...
                                                                              vertical: 8),
                                                                          decoration: BoxDecoration(
                                                                              color: editProvider.selectReligion == int.parse(data.id.toString()) ? AppColors.appColor : Theme.of(context).cardColor,
                                                                              borderRadius: BorderRadius.circular(40),
                                                                              border: Border.all(color: editProvider.selectReligion == int.parse(data.id.toString()) ? Colors.transparent : Theme.of(context).dividerTheme.color!)),
                                                                          child:
                                                                              Row(
                                                                            mainAxisSize:
                                                                                MainAxisSize.min,
                                                                            children: [
                                                                              Text(data.title.toString(), style: Theme.of(context).textTheme.bodySmall!.copyWith(color: editProvider.selectReligion == int.parse(data.id.toString()) ? AppColors.white : null)),
                                                                            ],
                                                                          ),
                                                                        ),
                                                                      );
                                                            ...
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                                        12),
                                                            border: Border.all(
                                                                color: editProvider.selectRelationShip ==
                                                                        int.parse(data
                                                                            .id
                                                                            .toString())
                                                                    ? AppColors
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      for (int a = 0;
                                          a < editProvider.relationShip!.length;
                                          a++)
                                        Builder(builder: (context) {
                                          Goallist data =
                            ...
                            ListTile(
                                ...
                                leading: SvgPicture.asset(
                                  "assets/icons/relere2.svg",
                                  colorFilter: ColorFilter.mode(
                                      Theme.of(context).indicatorColor,
                                      BlendMode.srcIn),
                                ),
                                title: editProvider
                                        .heightcontrooler.text.isEmpty
                                    ? const Text("Not Updated")
                                    : Text(
                                        "${editProvider.heightcontrooler.text} cm"),
  ...
  Widget commenTile(
      {required String titile, required Widget widget, required bool traing}) {
    return Column(
      children: [
        Row(
          children: [
