...
import '../../bloc/match_provider.dart';
import '../../bloc/match_states.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appBarCustom(context,
          AppLocalizations.of(context)?.translate("Explore") ?? "Explore"),
                    ...
                    onTap: () {
                      ...
                      Provider.of<DetailProvider>(context, listen: false)
                        ...
                        Navigator.pushNamed(
                          ...
                          matchProvider
                              .callAllApi(navigatorKey.currentContext!);
                        });
                      });
                    },
                    child: Stack(
                      ...
                      children: [
                        ...
                        Positioned(
                          bottom:
                              data.profileBio.toString().toUpperCase().isEmpty
                                  ? 40
                                  : 80,
                          child: ClipRRect(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      Navigator.pushNamed(
                        ...
                        matchProvider.callAllApi(navigatorKey.currentContext!);
                      });
                    },
                    child: ClipRRect(
                      borderRadius: const BorderRadius.vertical(
