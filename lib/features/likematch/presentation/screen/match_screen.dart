...
import '../../bloc/likematch_provider.dart';
...
class _MatchScreenState extends State<MatchScreen>
  ...
  void initState() {
    ...
    if (likeMatchProvider.isHome) {
      likeMatchProvider.profileViewApi(
          uid: Provider.of<HomeProvider>(context, listen: false).uid,
          profileId: likeMatchProvider.likeMatchData.first.profileId);
    }
  }
                    ...
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                          ...
                          style: Theme.of(context)
                              ...
                              .headlineSmall!
                              .copyWith(
                                  color: AppColors.appColor, fontSize: 25)),
                      TextSpan(
                          text:
                              "${likeMatchProvider.likeMatchData[likeMatchProvider.interIndex].profileName}",
                          style: Theme.of(context)
                              .textTheme
                              .headlineSmall!
                              .copyWith(
              ...
              Stack(
                ...
                children: [
                  CarouselSlider(
                      items: [
                        for (int a = 0;
                            a < likeMatchProvider.likeMatchData.length;
                            a++)
                          Row(
                            children: [
                              const SizedBox(
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                        color: AppColors.appColor, width: 8),
                                    image: DecorationImage(
                                        image: NetworkImage(
                                            "${Config.baseUrl}${Provider.of<HomeProvider>(context).userlocalData.userLogin!.otherPic.toString().split("\$;").first}"),
                                        fit: BoxFit.cover),
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image: NetworkImage(
                                            "${Config.baseUrl}${likeMatchProvider.likeMatchData[likeMatchProvider.interIndex].profileImages.first}"),
                                        fit: BoxFit.cover),
                                    borderRadius: const BorderRadius.only(
                                        topLeft: Radius.circular(80),
                            ...
                            if (likeMatchProvider.isHome) {
                              likeMatchProvider.profileViewApi(
                                  uid: Provider.of<HomeProvider>(context,
                                          listen: false)
                                      .uid,
                                  profileId: likeMatchProvider
                                      .likeMatchData[i].profileId);
                            }
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: CircularProgressIndicator(
                                ...
                                value: double.parse(
                                    "0.${likeMatchProvider.likeMatchData[likeMatchProvider.interIndex].matchRatio.toString().split(".").first}")),
                          ),
                          Text(
                              ...
                              children: [
                                ...List.generate(
                                  ...
                                  (index) {
                                    return Indicator(
                                      isActive:
                                          likeMatchProvider.interIndex == index
                                              ? true
                                              : false,
                                    );
                                  },
                  ...
                  children: [
                    ...
                    MainButton(
                      title: AppLocalizations.of(context)
                          ...
                          "Send a message",
                      iconpath: "assets/icons/chattingIcon.svg",
                      onTap: () {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => ChattingPage(
                                  resiverUserId: likeMatchProvider
                                      .likeMatchData[
                                          likeMatchProvider.interIndex]
                                      .profileId,
                                  resiverUseremail: likeMatchProvider
                                      .likeMatchData[
                                          likeMatchProvider.interIndex]
                                      .profileName,
                                  proPic: likeMatchProvider
                                      .likeMatchData[
                                          likeMatchProvider.interIndex]
                                      .profileImages
                                      .first),
                    ...
                    MainButton(
                      title: AppLocalizations.of(context)
                              ?.translate("Keep Swiping") ??
                          "Keep Swiping",
                      iconpath: "assets/icons/swiping.svg",
                      onTap: () {
                        Navigator.pop(context);
                      },
                    ),
